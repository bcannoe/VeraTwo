...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		char choice = 0;
		ArrayList<String> playerArray = new ArrayList<String>(50);
		...
		//This is a good menu
			...
			case 'C'://allows user to play slot machine
				...
				// hard coded values into player object for testing code 
				Name name = new Name("Ester", 'A', "Aguilera");
				Date dob = new Date(10,11,1995);
				Player selectedPlayer = new Player(name, dob, 10000);
				...
				while(selectedPlayer.getMoneyBalance() >= 1 && playAgain == 1)
				{
					 ...
					 * is validated & playSlots is invoked once again passing through it the necessary updated slot & player info as well the udpated userPlays;
					 */
